        ...
        return(
                <View style={Styles.container}>
                     ...
                     <View style={Styles.conatiner3}>
                         ...
                         />
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('MainGym')} style={Styles.buttontext} >
                    ...
                    <Text style={Styles.passwordtext} onPress={()=> this.ForgotPassword()}>Forgot password?</Text>
                        ...
                        <Text style={Styles.createaccounttext}>Don't have an account? <Text style={{textDecorationLine: 'underline',fontSize:14.8}} onPress={()=>this.props.navigation.navigate('Createaccount')}>Create New</Text></Text>
                         </View>
                    </View>

        ...
        return(
                <View style={Styles.container}>
                     ...
                     <View style={Styles.conatiner3}>
                         ...
                         />
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('MainGym')} style={Styles.button}>
                        <Text style={{color:'white',fontSize:21,textAlign:'center'}}>Login</Text>
                    </TouchableOpacity>
                    <Text style={Styles.passwordtext} onPress={()=> this.ForgotPassword()}>Forgot password?</Text>
                        
                         </View>
                         <View style={{flex:2,alignItems:'center',}}>
                        <Text style={Styles.createaccounttext}>Don't have an account? <Text style={Styles.createaccounttextinside} onPress={()=>this.props.navigation.navigate('Createaccount')}>Create New</Text></Text>
                         </View>
                    </View>
...
const Styles = StyleSheet.create({
  ...
  createaccounttextinside : {textDecorationLine: 'underline',fontSize:14.8},

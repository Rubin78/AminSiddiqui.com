    ...
    render(){
        return(
                <View style={Styles.container}>
                     ...
                     {/* <Image style={Styles.img} source={require('../assets/logobuilder.jpg')}/> */}

                         <TextInput style={{borderWidth:1.5,borderColor:'#73D5E8',paddingHorizontal:heightPercentageToDP(2),width:widthPercentageToDP(84),height: heightPercentageToDP(8),margin:30,marginBottom:0,backgroundColor:'transparent',fontSize:17,borderRadius:4,color:'#4C4B4B'}}
                          onChangeText={(text) => this.setState({text})}
                          value={this.state.text}
                         placeholder='Email'
                         placeholderTextColor = "#73D5E8"
                         />
                            <TextInput style={{borderWidth:1.5,borderColor:'#73D5E8',paddingHorizontal:heightPercentageToDP(2),width:widthPercentageToDP(84),height: heightPercentageToDP(8),margin:30,marginTop:18,backgroundColor:'transparent',fontSize:17,borderRadius:4}}
